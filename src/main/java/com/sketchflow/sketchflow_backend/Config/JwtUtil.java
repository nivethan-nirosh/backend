...
public class JwtUtil {
    ...
    // A strong, random, secret key. In a real app, put this in application.properties!
    ...
    public String generateToken(User user) {
        ...
        // You can add extra data (claims) to the token here
    ...
    // --- Helper methods to read data from the token ---
